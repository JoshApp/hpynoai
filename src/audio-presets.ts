...
export function buildStageAudioPreset(
  ...
  if (stage.ambient) {
    ...
    if (a.padLevel !== undefined) preset.pad!.volume = a.padLevel * 0.4;
    if (a.noiseLevel !== undefined) preset.noise!.volume = a.noiseLevel * 0.15;
    if (a.melodyLevel !== undefined) preset.melody!.volume = a.melodyLevel * 0.1;
