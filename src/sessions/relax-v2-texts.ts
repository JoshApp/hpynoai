...
export const generatedTexts: Record<string, string[]> = {
  ...
  'deepening': [
    ...
    'heavier now... and that heaviness... is not weight... it\'s permission... permission to stop trying. ... would you like to go deeper?',
...
export const stageInteractions: Record<string, Array<{ index: number; type: string; text: string }>> = {
  ...
  'deepening': [
    { index: 5, type: 'gate', text: 'heavier now... and that heaviness... is not weight... it\'s permission... permission to stop trying. ... would you like to go deeper?' },
  ],
};
